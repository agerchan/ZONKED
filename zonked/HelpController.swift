...
class HelpController: UIViewController {
    ...
    @IBOutlet weak var helpscreenlogo: UIImageView!
    
    
    @IBOutlet weak var sidewaystext: UILabel!
    ...
    func disclamir () {
        ...
        memotriangleh?.isHidden = true
        textimage?.image = UIImage(named: "3rd")
    }
    func memo () {
        helpscreenlogo?.isHidden = false
        sidewaystext?.text = "Gabriella Ardiles and Anna Gerchanovsky would like to thank our friends for helping us create this game. " +
        ...
        textimage?.image = UIImage(named: "4th")
    }
    ...
    @IBAction func secretPressed(_ sender: Any) {
        helpscreenlogo?.isHidden = true
        textimage?.image = UIImage(named: "gaby")
        sidewaystext?.text = "Hi Gaby!\nThis is an extra special thank you from me. " +
